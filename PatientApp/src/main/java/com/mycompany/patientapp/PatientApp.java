...
class GUI extends JFrame {
    ArrayList<Patients> patientsListArrayList=new ArrayList<Patients>();
...
super("Patient Details");
        ...
        submitButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent e) {
                 ...
                 if(nameText.getText().length()!=0 && nameText.getText().length()!=0 && bloodTypeCombo.getSelectedIndex()!=-1)
                 {
                   ...
                   Patients newPatient=new Patients(name,phone,bloodType,gender,hasInsurance,insuranceCompany);
...
"Confirm Patient Info.", JOptionPane.YES_NO_OPTION);
                 ...
                 {
                       JOptionPane.showMessageDialog(GUI.this,"You have to fill all the information","Missing Information",JOptionPane.WARNING_MESSAGE);
                 }
...
class Patients {
    ...
    public Patients(String name, String phone, String bloodType, char gender, String hasInsurance, String insuranceCompany) {
        this.name = name;
        this.phone = phone;
